...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/UPDATE-DARK-CYBER-BD71/APPROVED.txt/tree/main/ap.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        os.system('clear')
        os.system('xdg-open https://www.facebook.com/profile.php?id=100054268160889')
        logo()
        print('')
